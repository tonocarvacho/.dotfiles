...
# def is_youtube():
    # return "youtube.com" in c.url.host()

# def dark_mode_enabled():
    # # Disable dark mode for YouTube
    # if is_youtube():
        # return False

# # Enable dark mode if the background color is dark
...
# c.url.searchengines = {'DEFAULT': 'https://www.google.com/search?q={}', 'yt': 'https://www.youtube.com/results?search_query={}'}
...
# c.colors.hints.border = '1px solid #ffffff' 
...
config.bind('xt', 'config-cycle statusbar.show always never;; config-cycle tabs.show always never')

config.bind('<Ctrl-l>', 'tab-next')
config.bind('<Ctrl-k>', 'tab-prev')
config.bind('<Ctrl-u>', 'tab-focus 1')
config.bind('<Ctrl-i>', 'tab-focus 2')
config.bind('<Ctrl-o>', 'tab-focus 3')
config.bind('<Ctrl-p>', 'tab-focus 4')
config.bind('<Ctrl-y>', 'tab-focus 5')
config.bind('<Ctrl-j>', 'tab-focus last')
config.bind('<Ctrl-h>', 'back')
config.bind('<Ctrl-;>', 'forward')

config.bind('gi', 'open https://www.youtube.com')
config.bind('gu', 'open https://www.google.com')
config.bind('ti', 'open -t https://www.youtube.com')
config.bind('tu', 'open -t https://www.google.com')
