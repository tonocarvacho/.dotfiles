...
set noswapfile
set incsearch
set path+=**                            " Provides tab-completion for all
"file-related task, Search down into subfolders
set wildmenu                            " Display all matching files when we
"tab complete
set nohlsearch
set scrolloff=8
...
nmap <Leader>. :w<CR>:source ~/.vimrc<CR>
